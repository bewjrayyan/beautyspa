...
@section('title', trans('admin::resource.edit', ['resource' => trans('page::pages.page')]) . ' - ' . $page->name)
...
@section('content')
    <form method="POST" action="{{ route('admin.pages.update', $page) }}" class="form-horizontal page-editor-form" id="page-edit-form" novalidate>
        {{ csrf_field() }}
        {{ method_field('put') }}
