<div class="dashboard-panel dashboard-today-appointments">
    <div class="grid-header dashboard-panel__head">
        <h5>
            <i class="fa fa-calendar-check-o" aria-hidden="true"></i>
            {{ trans('admin::dashboard.today_appointments') }}
        </h5>
    ...
    <div class="table-responsive anchor-table">
        <table class="table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td class="empty" colspan="3">{{ trans('admin::dashboard.today_appointments_empty') }}</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
