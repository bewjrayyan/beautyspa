...
class PayFast implements GatewayInterface
{
    ...
    public function purchase(Order $order, Request $request)
    {
        ...
        $signature = static::generateSignature($data, setting('payfast_passphrase'));
    ...
    public function complete(Order $order): VerifiedPaymentResponse
    {
        $reference = app(GatewayPaymentVerifier::class)->verifyPayFast($order);

        return new VerifiedPaymentResponse($order, $reference);
    }
