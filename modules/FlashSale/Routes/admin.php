...
Route::get('flash-sales/products/search', [
    'as' => 'admin.flash_sales.products.search',
    'uses' => 'FlashSaleProductController@search',
    'middleware' => 'can:admin.flash_sales.index',
]);

Route::get('flash-sales/products/{product}', [
    'as' => 'admin.flash_sales.products.show',
    'uses' => 'FlashSaleProductController@show',
    'middleware' => 'can:admin.flash_sales.index',
]);
