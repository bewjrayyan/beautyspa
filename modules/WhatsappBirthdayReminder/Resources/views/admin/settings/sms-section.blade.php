...
@component('setting::admin.settings.partials.section', [
    ...
    @component('setting::admin.settings.partials.wa-notification-item', [
        ...
        <div class="st-section--media" style="margin: 12px 0;">
            ...
            <p class="help-block text-muted">{{ trans('whatsappbirthday::settings.image_help') }}</p>
        </div>
        ...
        <p class="help-block text-muted">{{ trans('whatsappbirthday::settings.schedule_time_help') }}</p>
