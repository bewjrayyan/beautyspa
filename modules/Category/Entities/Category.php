...
class Category extends Model implements Sitemapable
{
    ...
    public static function keyValuedTreeList()
    {
        try {
            return Cache::tags('categories')->rememberForever(md5('categories.key_valued_tree_list:' . locale()), function () {
                return static::buildKeyValuedTreeList();
            });
        } catch (Throwable) {
            return static::buildKeyValuedTreeList();
        }
    ...
    private static function buildTreeList()
    {
    ...
    private static function buildKeyValuedTreeList()
    {
        $categories = static::buildTreeList();
    ...
    private static function buildSearchable()
    {
    ...
    public function url()
    {
        return storefront_route('categories.products.index', ['category' => $this->slug]);
    }
    ...
    {
        return Url::create(storefront_route('categories.products.index', ['category' => $this->slug]))
