...
@if ($order->hasAppointmentDetails() || $order->beautician || $order->spaBranch || $bookings->isNotEmpty())
    <div id="order-fulfillment" class="order-show__card order-show__card--appointment">
        ...
        @if ($bookings->isNotEmpty())
            <div @class([
                'order-show__appt-bookings',
                'order-show__appt-bookings--multi' => $bookings->count() > 1,
            ])>
                @foreach ($bookings as $booking)
                    ...
                    @endphp
                    <article class="order-show__appt-booking order-show__appt-booking--glass">
                        <div class="order-show__appt-booking-grid">
                            <div class="order-show__appt-booking-col order-show__appt-booking-col--details">
                            ...
                            <div class="order-show__appt-booking-col order-show__appt-booking-col--schedule">
                                ...
                                @else
                                    <div class="order-show__appt-schedule order-show__appt-schedule--compact">
                                ...
                                @if ($booking->beautician && $canOpenJobSheet)
                                    <div class="order-show__job-sheet-action order-show__job-sheet-action--compact">
                                        <div>
        ...
        @elseif ($order->appointment_date || $order->appointment_time || $order->beautician)
