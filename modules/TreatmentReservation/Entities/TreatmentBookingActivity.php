...
class TreatmentBookingActivity extends Model
{
    ...
    public const ACTION_EMAIL_REMINDER_SENT = 'email_reminder_sent';
    ...
    public function actionLabel(): string
    {
        return match ($this->action) {
            ...
            self::ACTION_CHECKED_IN => trans('treatmentreservation::admin.activity.checked_in'),
            ...
            self::ACTION_EMAIL_REMINDER_SENT => trans('treatmentreservation::admin.activity.email_reminder_sent'),
    ...
    public function summary(): string
    {
        return match ($this->action) {
            ...
            self::ACTION_CHECKED_IN => trans('treatmentreservation::admin.activity.checked_in_summary'),
            ...
            self::ACTION_EMAIL_REMINDER_SENT => trans('treatmentreservation::admin.activity.email_reminder_summary'),
