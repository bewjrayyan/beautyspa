...
@section('content')
    ...
    <div class="tr-reservations tr-reservations-page tr-reservations--view-{{ $activeView }}{{ $activeView === 'dashboard' ? ' tr-reservations--crm-dashboard tr-reservations--mockup' : '' }}" id="tr-reservations-app"
        ...
        data-cal-preview-duration-minutes="{{ TrLang::trans('admin.crm.agenda_duration_minutes') }}"
        ...
        data-cal-preview-branch="{{ TrLang::trans('admin.crm.spa_branch') }}"
        data-cal-preview-booking-id="{{ TrLang::trans('admin.crm.agenda_booking_id') }}"
