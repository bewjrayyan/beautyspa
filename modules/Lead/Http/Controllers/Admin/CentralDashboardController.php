...
final class CentralDashboardController
{
    ...
    public function __invoke(Request $request, ?string $view = null): View|RedirectResponse
    {
        ...
        return view('lead::admin.central.index', [
            ...
            'notificationStorageKey' => 'imma-central.notifications.v1.'.(string) ($user?->getAuthIdentifier() ?? 'guest'),
            ...
            'checkinConfirmUrlTemplate' => url('admin/leads/checkin/__ID__/confirm'),
            'checkinPassBaseUrl' => url('appointment-check-in'),
            'clearanceUrl' => route('admin.leads.clearance.index'),
            'clearanceStatusUrlTemplate' => url('admin/leads/clearance/__ID__/status'),
            ...
            'canConfirmCheckin' => $user?->hasAccess('admin.leads.edit') ?? false,
            ...
            'canEditTreatments' => $user?->hasAccess('admin.treatment_reservations.edit') ?? false,
