...
<div class="coupon-form-tab">
    <div class="coupon-form-sheet">
        <div class="coupon-form-sheet__col">
            <div class="coupon-form-section">
                <div class="coupon-form-section__header">
                    <span class="coupon-form-section__icon"><i class="fa fa-money" aria-hidden="true"></i></span>
                    <div><h3>{{ trans('coupon::coupons.form.sections.spend') }}</h3><p>{{ trans('coupon::coupons.form.sections.spend_lead') }}</p></div>
                </div>
                <div class="coupon-form-section__fields coupon-form-section__fields--pair">
                    {{ Form::number('minimum_spend', trans('coupon::attributes.minimum_spend'), $errors, $coupon, array_merge($field, ['min' => 0, 'step' => '0.01'])) }}
                    {{ Form::number('maximum_spend', trans('coupon::attributes.maximum_spend'), $errors, $coupon, array_merge($field, ['min' => 0, 'step' => '0.01'])) }}
                </div>
            </div>

            <div class="coupon-form-section">
                <div class="coupon-form-section__header">
                    <span class="coupon-form-section__icon"><i class="fa fa-cube" aria-hidden="true"></i></span>
                    <div><h3>{{ trans('coupon::coupons.form.sections.products') }}</h3><p>{{ trans('coupon::coupons.form.sections.products_lead') }}</p></div>
                </div>
        ...
        <div class="coupon-form-sheet__col">
            <div class="coupon-form-section">
                <div class="coupon-form-section__header">
                    <span class="coupon-form-section__icon"><i class="fa fa-folder-open" aria-hidden="true"></i></span>
                    <div><h3>{{ trans('coupon::coupons.form.sections.categories') }}</h3><p>{{ trans('coupon::coupons.form.sections.categories_lead') }}</p></div>
                </div>
                <div class="coupon-form-section__fields">
