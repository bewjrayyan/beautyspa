...
@section('content')
    ...
    <div class="auth-wrapper">
        <a href="{{ $storefrontHref }}" class="back-to" title="{{ trans('user::auth.back_to_home') }}">
        ...
        <div class="auth-right">
            ...
            <div class="auth-form">
                ...
                <div
                    class="auth-form-body admin-beautician-otp"
                    x-data="{
                        mode: @js($loginMode ?? 'email'),
                        step: 'phone',
                        phone: '',
                        phoneValid: false,
                        otp: '',
                        loading: false,
                        error: '',
                        invalidPhoneMessage: @js(trans('core::validation.phone')),
                        sendUrl: @js(route('admin.login.whatsapp.send_otp')),
                        ...
                        async sendOtp() {
                            ...
                            if (phoneInput?._iti) {
                                ...
                                this.phone = phoneInput._iti.getNumber();
                            }
