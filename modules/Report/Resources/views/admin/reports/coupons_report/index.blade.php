            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('report::admin.table.unique_customers') }}</th>
                        <th>{{ trans('report::admin.table.discount') }}</th>
                        <th>{{ trans('report::admin.table.orders_total') }}</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    @forelse ($report as $data)
                        <tr>
                            ...
                            <td>{{ \Modules\Support\Money::inDefaultCurrency($data->orders_total)->format() }}</td>
                        </tr>
                    @empty
                        <tr>
