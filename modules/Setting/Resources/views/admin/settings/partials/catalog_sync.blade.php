@php
    ...
    $hasExportRoute = Route::has('admin.catalog_sync.export');
    $hasImportRoute = Route::has('admin.catalog_sync.import');
    $hasImportStoredRoute = Route::has('admin.catalog_sync.import_stored');
    $hasPullRoute = Route::has('admin.catalog_sync.pull');
@endphp
