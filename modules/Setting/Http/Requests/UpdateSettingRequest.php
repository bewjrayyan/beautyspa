    ...
    private function allRules(): array
    {
        return array_merge([
            ...
            'onesender_whatsapp_group_id' => [
                'nullable',
                'required_if:whatsapp_completed_group_enabled,1',
                'regex:/^\d+@g\.us$/',
            ],
            'bank_transfer_payment_proof_whatsapp_enabled' => 'required|boolean',
            'bank_transfer_payment_proof_whatsapp_group_id' => [
                'nullable',
                'required_if:bank_transfer_payment_proof_whatsapp_enabled,1',
                'regex:/^\d+@g\.us$/',
            ],
            'bank_transfer_payment_proof_whatsapp_message' => 'nullable|string|max:8000',
            ...
            'whatsapp_status_notify_customer_enabled' => 'required|boolean',
            'whatsapp_status_notify_beautician_enabled' => 'required|boolean',
            ...
            'whatsapp_welcome_message' => 'nullable|string|max:4000',
            'whatsapp_customer_reminder_enabled' => 'required|boolean',
            'whatsapp_customer_reminder_minutes' => 'nullable|integer|min:15|max:1440',
            'whatsapp_customer_reminder_message' => 'nullable|string|max:4000',
            'whatsapp_customer_completed_enabled' => 'required|boolean',
            'whatsapp_customer_completed_message' => 'nullable|string|max:4000',
            'whatsapp_customer_followup_enabled' => 'required|boolean',
            'whatsapp_customer_followup_days' => 'nullable|integer|min:1|max:90',
            'whatsapp_customer_followup_message' => 'nullable|string|max:4000',
            'new_order_admin_sms' => 'required|boolean',
            'whatsapp_new_order_admin_message' => 'nullable|string|max:4000',
            'new_order_sms' => 'required|boolean',
            'whatsapp_new_order_customer_message' => 'nullable|string|max:4000',
            'whatsapp_order_status_message' => 'nullable|string|max:4000',
            'whatsapp_status_beautician_message' => 'nullable|string|max:4000',
            'whatsapp_completed_group_message' => 'nullable|string|max:8000',
            'whatsapp_completed_beautician_message' => 'nullable|string|max:8000',
            'whatsapp_beautician_new_booking_message' => 'nullable|string|max:4000',
            'whatsapp_beautician_reminder_message' => 'nullable|string|max:4000',
            ...
            'chip_fpx_surcharge' => 'nullable|integer|min:0|max:100000',
            ...
            'chip_card_surcharge_percent' => 'nullable|numeric|min:0|max:100',
            ...
            'chip_atome_surcharge_percent' => 'nullable|numeric|min:0|max:100',
            'chip_atome_whitelist' => 'nullable|string|max:500',
            'chip_ewallet_enabled' => 'required|boolean',
            'translatable.chip_ewallet_label' => 'required_if:chip_ewallet_enabled,1',
            'translatable.chip_ewallet_description' => 'required_if:chip_ewallet_enabled,1',
            'chip_ewallet_surcharge_percent' => 'nullable|numeric|min:0|max:100',
            'chip_ewallet_whitelist' => 'nullable|string|max:500',
            'chip_duitnow_enabled' => 'required|boolean',
            'translatable.chip_duitnow_label' => 'required_if:chip_duitnow_enabled,1',
