...
return [
  /*
    ...
    */
    ...
    'bank_transfer_payment_proof_whatsapp_enabled' => filter_var(env('BANK_TRANSFER_PAYMENT_PROOF_WHATSAPP_ENABLED', true), FILTER_VALIDATE_BOOLEAN),
    'bank_transfer_payment_proof_whatsapp_group_id' => env('BANK_TRANSFER_PAYMENT_PROOF_WHATSAPP_GROUP_ID', ''),
    'bank_transfer_payment_proof_whatsapp_message' => env('BANK_TRANSFER_PAYMENT_PROOF_WHATSAPP_MESSAGE', implode("\n", [
    ...
    'whatsapp_status_notify_customer_enabled' => filter_var(env('WHATSAPP_STATUS_NOTIFY_CUSTOMER_ENABLED', true), FILTER_VALIDATE_BOOLEAN),
    'whatsapp_status_notify_beautician_enabled' => filter_var(env('WHATSAPP_STATUS_NOTIFY_BEAUTICIAN_ENABLED', true), FILTER_VALIDATE_BOOLEAN),
    ...
    'whatsapp_status_beautician_message' => env('WHATSAPP_STATUS_BEAUTICIAN_MESSAGE', implode("\n", [
