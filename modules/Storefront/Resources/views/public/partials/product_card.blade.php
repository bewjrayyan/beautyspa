<div x-data="ProductCard({{ $data ?? 'product' }})" class="product-card">
    <div class="product-card-top">
        ...
        <ul class="list-inline product-badge">
            <template x-if="showTreatmentBadge">
                <li class="badge badge-info">
                    {{ trans("storefront::product_card.treatment") }}
                </li>
            </template>

            <template x-if="showOutOfStockBadge">
    ...
    <div class="product-card-bottom">
        <div class="product-price">
            <span
                ...
                x-text="hasPriceRange ? '{{ trans('storefront::product_card.price_range') }}' : '{{ trans('storefront::product_card.normal_price') }}'"
            ></span>

            <span class="previous-price" x-text="displayPrice"></span>

            <template x-if="hasSpecialPrice && !hasPriceRange">
