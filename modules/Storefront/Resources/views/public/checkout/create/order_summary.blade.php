                    ...
                    <template x-for="cartItem in cart.items" :key="cartItem.id">
                        <li x-data="CartItem(cartItem)" class="cart-item">
                            <a :href="productUrl" class="product-image">
                                ...
                                <span class="qty-count qty-count--modern" x-text="cartItem.qty"></span>
                            </a>
                    ...
                    <template x-if="$store.cart.hasLoyalty">
                        <li>
                            <label>
                                ...
                                <span class="btn-remove-coupon" @click="removeLoyalty">
                                    <i class="las la-times"></i>
                                </span>
                            </label>

                            <span class="color-primary" x-text="`-${formatCurrency($store.cart.loyaltyValue)}`"></span>
                        </li>
                    </template>
