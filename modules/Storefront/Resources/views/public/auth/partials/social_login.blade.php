@php
    ...
    $showFooterWhatsappOtp = $whatsappOtpEnabled && ! request()->routeIs('login');
    $hasSocialProviders = count($providers) !== 0 || $showFooterWhatsappOtp;
@endphp
...
<div class="auth-form-footer">
    ...
    @if ($hasSocialProviders)
        <div class="auth-form-social-links">
            ...
            @if ($showFooterWhatsappOtp)
                <button
                    type="button"
                    class="sign-in-whatsapp"
                ...
                >
                    ...
                    <span>{{ setting('whatsapp_otp_login_label') ?: trans('user::auth.sign_in_with_whatsapp') }}</span>
                </button>
            @endif
        </div>
    @endif
    ...
    @if ($showFooterWhatsappOtp)
        @include('storefront::public.auth.partials.whatsapp_otp_modal')
    @endif
