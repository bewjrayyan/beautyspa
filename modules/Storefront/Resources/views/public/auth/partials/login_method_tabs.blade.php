<div class="customer-login-tabs__tabs" role="tablist" aria-label="{{ trans('user::auth.login_email_tab') }} / {{ trans('user::auth.login_whatsapp_tab') }}">
    <button
        type="button"
        role="tab"
        class="customer-login-tabs__tab"
