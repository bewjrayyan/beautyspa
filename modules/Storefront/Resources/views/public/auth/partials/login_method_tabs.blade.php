<div class="customer-login-tabs__tabs">
    ...
    <button type="button" class="customer-login-tabs__tab" :class="{ 'is-active': mode === 'whatsapp' }" @click="mode = 'whatsapp'; initPhoneInput()">
        ...
        <span>{{ setting('whatsapp_otp_login_label') ?: trans('user::auth.login_whatsapp_tab') }}</span>
    </button>
</div>
...
<div x-show="mode === 'whatsapp'" x-cloak class="customer-login-tabs__panel">
    <template x-if="error">
        <p class="text-red" x-text="error"></p>
    </template>

    <template x-if="success">
        <p class="text-green" x-text="success"></p>
    </template>
