...
@section('panel')
    <div x-data="Wishlist" class="panel">
        ...
        <div x-cloak class="panel-body" :class="{ loading: fetchingWishlist }">
            ...
            <template x-if="!wishlistIsEmpty">
                <div class="account-product-cards account-product-cards--wishlist d-lg-none">
                    <template x-for="product in products.data" :key="'wishlist-card-' + product.id">
                        <div class="account-product-card" x-data="WishlistItem(product)">
                            <div class="account-product-card__main">
                                ...
                                <div class="account-product-card__info">
                                    ...
                                    <span class="account-product-card__price" x-html="productPrice"></span>
