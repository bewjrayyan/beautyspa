<div class="product-details-info position-relative flex-grow-1"> 
    ...
    <div class="details-info-middle">
        ...
        <div
            class="product-special-price-countdown"
            x-cloak
            x-show="specialPriceCountdownVisible"
        >
            <div class="product-special-price-countdown__header">
                <div class="product-special-price-countdown__title">
                    <span class="product-special-price-countdown__icon" aria-hidden="true">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                            <path d="M12 2L13.09 8.26L19 7L14.74 11.09L21 12L14.74 12.91L19 17L13.09 15.74L12 22L10.91 15.74L5 17L9.26 12.91L3 12L9.26 11.09L5 7L10.91 8.26L12 2Z" fill="currentColor"/>
                        </svg>
                    </span>

                    <span
                        class="product-special-price-countdown__label"
                        x-text="specialPriceCountdownLabel"
                    ></span>
                </div>

                <span class="product-special-price-countdown__badge">
                    {{ trans('storefront::product.promo_limited_offer') }}
                </span>
            </div>

            @include('storefront::public.partials.special_price_countdown')
        </div>
