<ul class="sidebar-more-menu-items">
    <li>
        <a href="{{ storefront_route('contact.create') }}">
    ...
    @if (setting('storefront_blogs_section_enabled'))
        <li>
            <a href="{{ storefront_route('blog_posts.index') }}">
                <div class="sidebar-icon-parent">
    ...
    @if (app('modules')->isEnabled('TreatmentReservation'))
        <li>
            <a href="{{ storefront_route('treatment_reservations.booking.lookup') }}">
                <div class="sidebar-icon-parent">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <span>{{ trans('treatmentreservation::public.nav_link') }}</span>
            </a>
        </li>
    @endif
</ul>
