...
export function useVariants() {
    ...
    function isDefaultVariant(variant) {
        return variant.is_default === true || variant.is_default === 1;
    }
    ...
    function setDefaultVariant() {
        ...
        syncDefaultVariantMediaFromProduct();
    }
    ...
    function setDefaultVariantUid() {
        ...
        const defaultVariant = form.variants.find(isDefaultVariant);
        ...
        defaultVariantUid.value = defaultVariant.uid;

        syncDefaultVariantMediaFromProduct();
    }

    function clearDefaultVariant() {
        resetDefaultVariant();
        defaultVariantUid.value = "";
    }

    function syncDefaultVariantMediaFromProduct() {
        if (
            !hasAnyVariant.value ||
            !defaultVariantUid.value ||
            !form.media?.length
        ...
        const defaultVariant = form.variants.find(
            (variant) => variant.uid === defaultVariantUid.value,
        );
