...
export default class {
    ...
    transform(data) {
        ...
        if (hasAnyVariant.value) {
            // Variant products use variant-level pricing; do not send null base price.
            delete this.data.price;
            delete this.data.special_price;
            delete this.data.special_price_start;
            delete this.data.special_price_end;
            delete this.data.sku;
            delete this.data.qty;

            this.data.special_price_type =
                this.data.special_price_type || "fixed";
            this.data.manage_stock = 0;
            this.data.in_stock = 1;
        } else if (
