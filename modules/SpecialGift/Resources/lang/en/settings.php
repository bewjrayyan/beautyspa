...
return [
    ...
    'voucher_background_help' => 'A default gift voucher design is used out of the box. Upload or pick from the media library to use your own template. Recipient name and order number are drawn on the image.',
    'voucher_background_default' => 'Default design',
    'message_template' => 'WhatsApp message template',
    'message_template_default' => 'Hi {recipient_name}! Order: {order_number}. From: {sender_name}',
