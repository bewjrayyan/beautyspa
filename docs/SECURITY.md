...
- Online checkout completion verifies CHIP payments server-side using signed callbacks and the CHIP API.
...
| Area | Location |
|------|----------|
| CHIP webhook verification | `modules/Payment/Services/ChipWebhookSignatureVerifier.php` |
